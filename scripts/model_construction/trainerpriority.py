...
if __name__ == "__main__":
    ...
    # - `xloc=f"../../results/xblock/priority/{hyperparameter}/"`: Sets the location path for X data blocks based on the `hyperparameter` value.
    # Returns:
    # - `Xdata`: Feature data array.
    # - `_`: An unused value returned by `load`.
    # - `lab`: Label data array.
    Xdata, _, lab = load(
        index_number, category, xloc=f"../../results/xblock/priority/{hyperparameter}/"
    )
    ...
    # - `3`: Specifies the hyperparameter index directly.
    # Returns:
